...
/*  6/29/90 J. Henikoff
 >>>>>>>>>>>>>>>>>>>>>>>>>Blocks 9.0<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
  ...
  10/28/97  Changed MOTAUTO4 from 2 to 3 and MOTAUTO3 from 12 to 6
   1/18/98  Changed MAXSEQS & MAXFREQ from 715 to 400
--------------------------------------------------------------------------*/
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
...
#define MAXSEQS	  	  2000   /* Max number of sequences to be analyzed */
#define MINSEQS           2     /* Min number of sequences to be analyzed */
#define MAXFREQ           400   /* Max occurences of motif in all seqs */
...
#define MAX_MOTIFS	  200	/* Buffer motifs before discarding */
...
#define FNAMELEN              120       /* Max length of file name */

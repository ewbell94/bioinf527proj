...
#define MAXSEQS	  	  10000   /* Max number of sequences to be analyzed */
...
#define SNAMELEN              18       /* Max length of sequence name */
#define IDLEN                 12       /* Max length of db id */
#define FNAMELEN              80       /* Max length of file name */
#define MAXLINE               800      /* Max line length for ASCII file */
